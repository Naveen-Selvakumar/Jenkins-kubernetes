pipeline {
    ...
    environment {
        FRONTEND_IMAGE = "naveen014/frontend-app:latest"  // Update with your DockerHub username
        BACKEND_IMAGE = "naveen014/backend-app:latest"
        FRONTEND_CONTAINER = "frontend-container"
        BACKEND_CONTAINER = "backend-container"
        REGISTRY_CREDENTIALS = "naveen114"  // Jenkins credentials ID for Docker login
    }
